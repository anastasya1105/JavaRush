package com.javarush.pivovarova.task.task14.task1417;
import com.javarush.pivovarova.task.task14.task1417.Money;
...
public class Solution {
    ...
    static class Person {
        ...
        Person(String name) {
            ...
            allMoney.add(new Hryvnia(0.86));
            allMoney.add(new Ruble(1.18));
            allMoney.add(new USD(54.6));
        }
